(function(k,o,p,l){
    var a=k[l.k]={
        ...
        f:function(){
            return{
                ...
                make:function(b){
                    ...
                    for(e in b)if(b[e].hasOwnProperty){
                        ...
                        for(d in b[e])if(b[e][d].hasOwnProperty)if(typeof b[e][d]==="string")c[d]=b[e][d];break
                    }
                    return c
                    },
                ...
                click:function(b){
                    b=b||a.w.event;
                    var c=null;
                    if(c=b.target?b.target.nodeType===3?b.target.parentNode:b.target:b.srcElement)if(c===
                        a.s.x)a.f.close();
            ...
            if(b.styleSheet)b.styleSheet.cssText=c;else b.appendChild(a.d.createTextNode(c));
            a.d.h.appendChild(b)
            },
    ...
    i.onload=function(){
        ...
        this.style.marginLeft=m<a.a.thumbCellSize?
        -m/2+"px":"-"+a.a.thumbCellSize/2+"px";
...
if(d!=="image")(d=a.s.bd.getElementsByTagName("SPAN")[1])?d.parentNode.insertBefore(h,d):a.s.bd.appendChild(h);else a.s.bd.appendChild(h)
    },
call:function(b,c){
...
"#_bd span#_logo {background: #FCF9F9 url(http://d3io1k5o0zdpqr.cloudfront.net/images/about/LogoAbout.png) 50% 50% no-repeat; box-shadow: none; }",'#_bd a#_x {height: 36px; line-height: 36px; position: fixed; font-size: 14px; font-weight: bold; display: block; width:auto; top: 0; left: 0; right: 0; margin: 0; background: url("http://d3io1k5o0zdpqr.cloudfront.net/images/fullGradient07Normal.png") repeat-x scroll 0 0 #FFFFFF; border-bottom: 1px solid #CCCCCC; color: #211922; text-align: center; z-index:8675321; }',
'#_bd a#_x:active {background-color: #211922; background-image: url("http://d3io1k5o0zdpqr.cloudfront.net/images/fullGradient07Inverted.png"); border-color: #211922; text-shadow: 0 -1px #211922; }',"#_bd a#_x:hover {color: #fff; text-decoration: none; background-color: #1389e5; border-color: #1389e5; text-shadow: 0 -1px #46A0E6;}","#_bd a img {max-height:200px; max-width:200px; top: 50%; left: 50%; position: absolute; z-index:8675312; }","#_bd a b { z-index: 8675315; position: absolute; top: 50%; left: 50%; height: 50px; width: 50px; background: transparent url(http://d3io1k5o0zdpqr.cloudfront.net/images/VideoIndicator.png) 0 0 no-repeat; margin-top: -25px; margin-left: -25px; }",
