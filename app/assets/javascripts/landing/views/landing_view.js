Landing.ApplicationView = Ember.View.extend({
  templateName: 'landing/templates/landing-application',

});
Landing.EmailView = Ember.View.extend({
  templateName: 'landing/templates/landing-email',
...
Landing.LetterView = Ember.View.extend({
  templateName: 'landing/templates/landing-letter',
...
Landing.CheckingView = Ember.View.extend({
  templateName: 'landing/templates/landing-checking'
});
Landing.SignupView = Ember.View.extend({
  templateName: 'landing/templates/landing-signup',
...
Landing.DemographicsView = Ember.View.extend({
  templateName: 'landing/templates/landing-demographics',
